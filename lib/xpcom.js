...
const CONSTRUCTORS = {
    ...
    nsIBinaryInputStream: CC('@mozilla.org/binaryinputstream;1', 'nsIBinaryInputStream', 'setInputStream'),
   ...
   // nsIWindowMediator: CC('@mozilla.org/appshell/window-mediator;1'), // https://developer.mozilla.org/en-US/docs/XPCOM_Interface_Reference/nsIWindowMediator
    ...
    nsIConverterInputStream: CC('@mozilla.org/intl/converter-input-stream;1', 'nsIConverterInputStream', 'init'), // https://developer.mozilla.org/en-US/docs/XPCOM_Interface_Reference/nsIConverterInputStream
    nsIXMLHttpRequest: CC('@mozilla.org/xmlextras/xmlhttprequest;1', 'nsIXMLHttpRequest'), // https://developer.mozilla.org/en-US/docs/nsIXMLHttpRequest
    nsIIOService: CC('@mozilla.org/network/io-service;1', 'nsIIOService'), // https://developer.mozilla.org/en-US/docs/XPCOM_Interface_Reference/nsIIOService
    nsIStorageStream: CC('@mozilla.org/storagestream;1', 'nsIStorageStream', 'init'),
    //nsIUUIDGenerator: CC('@mozilla.org/uuid-generator;1', 'nsIUUIDGenerator') // https://developer.mozilla.org/en-US/docs/XPCOM_Interface_Reference/nsIUUIDGenerator
    nsICategoryManager: CC('@mozilla.org/categorymanager;1', 'nsICategoryManager'),
    nsIURI: CC('@mozilla.org/network/simple-uri;1', 'nsIURI')
};
...
const QI = {
    ...
    nsITraceableChannel: channel => channel.QueryInterface(Ci.nsITraceableChannel),
    nsIHttpChannel: channel => channel.QueryInterface(Ci.nsIHttpChannel)
};
...
// Export interfaces
const INTERFACES = {
    nsISupportsPriority: Ci.nsISupportsPriority,
    nsIProtocolHandler: Ci.nsIProtocolHandler
};

exports.Ci = INTERFACES;
